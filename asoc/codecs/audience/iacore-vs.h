...
#define IA_GET_KW_LENGTH	_IO('T', 0x023)

#define MAX_KW_MODELS 5
#define IA_SYSCONFIG_MAJOR_OFFSET	0x20
#define IA_BOSKO_MAJOR_OFFSET		0x20

#define IA_GET_KW_LENGTH_CMD		0x8027
#define IA_KW_LEN_ALGO_PARAM		0x5003
...
#else
static inline int iacore_set_bargein_vq_mode(struct iacore_priv *iacore,
								u32 enable)
{
	return 0;
}
